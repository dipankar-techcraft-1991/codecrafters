  ...
  return (
    <nav className="flex justify-between items-center p-4 bg-navbar shadow-2xl">
      ...
      <button
        ...
        className="text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 font-medium rounded-lg text-sm px-1 py-1 text-center me-2 mb-2"
      >
        {darkMode ? (
